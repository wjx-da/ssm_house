	...
	<div class="col-md-9 wow fadeInLeft">
		...
		<div class="row">
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>UserInfo/<%=userInfo.getUser_name() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=userInfo.getPhoto()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		身份证:<%=userInfo.getCardNumber() %>
			     	</div>
			     	<div class="field">
	            		籍贯:<%=userInfo.getCity() %>
			     	</div>
			     	<div class="field">
	            		家庭地址:<%=userInfo.getAddress() %>
			     	</div>
