...
<div class="container">
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">密码:</div>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">身份证:</div>
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><img class="img-responsive" src="<%=basePath %><%=userInfo.getPhoto() %>"  border="0px"/></div>
	</div>
	<div class="row bottom15"> 
