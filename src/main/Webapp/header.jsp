            ...
            <ul class="nav navbar-nav navbar-left">
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="${pageContext.request.contextPath}/user/register.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;注册</a></li>
                <li><a href="${pageContext.request.contextPath}/user/login.jsp"><i class="fa fa-user"></i>&nbsp;&nbsp;登录</a></li>
