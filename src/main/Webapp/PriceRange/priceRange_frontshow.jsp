...
<div class="container" style="height: 780px">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>PriceRange/frontlist">租金范围信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">记录编号:</div>
		<div class="col-md-10 col-xs-6"><%=priceRange.getRangeId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">价格区间:</div>
		<div class="col-md-10 col-xs-6"><%=priceRange.getPriceName()%></div>
	</div>
	<div class="row bottom15">
