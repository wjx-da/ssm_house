...
<%@ page import="com.wanjiaxin.po.NewsInfo" %>
...
<div class="container">
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=newsInfo.getNewsId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">标题:</div>
		<div class="col-md-10 col-xs-6"><%=newsInfo.getNewsTitle()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">新闻内容:</div>
		<div class="col-md-10 col-xs-6"><%=newsInfo.getNewsContent()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">发布日期:</div>
		<div class="col-md-10 col-xs-6"><%=newsInfo.getNewsDate()%></div>
	</div>
	<div class="row bottom15">
